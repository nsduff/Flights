...
function ResultCard({ flight }) {
    ...
    return (
        <Link
            to={`/flights/${flight.cityCodeFrom}/${flight.cityCodeTo}/${flight.dTime}/${flight.id}`}
        >
            <div className="result-card">
                <div className="numbers">
                    ...
                    <div>
                        <h6>
                            <b>Departs {flight.cityFrom}:</b>{' '}
                            {convertTime(flight.dTime)}
                        </h6>
                        <h6>
                            <b>Arrives {flight.cityTo}:</b>{' '}
                            {convertTime(flight.aTime)}
                        </h6>
                    </div>
                </div>
